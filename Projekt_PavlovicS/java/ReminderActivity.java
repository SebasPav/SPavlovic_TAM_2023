...
public class ReminderActivity extends AppCompatActivity {
    ...
    private void processinsert(String title, String date, String time) {
        String result = new DataBase(this).addreminder(title, date, time);
        //inserts the title,date,time into sql lite database
        setAlarm(title, date, time);
        //calls the setalarm method
        mTitledit.setText("");
    ...
    public String FormatTime(int hour, int minute) {
        //this method converts the time into 12hr format and assigns am, pm
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        //this intent will be called once the setting alarm is completes
